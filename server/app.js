...
module.exports = function (app) {
	...
	var username = process.env.MLAB_USERNAME_WEBDEV; // get from environment var password = process.env.MLAB_PASSWORD_WEBDEV;
	connectionString = 'mongodb://' + username + ':' + password; 
	connectionString += ' @ds229468.mlab.com:29468/heroku_dhdtp04k '; // use yours
	}
};
